...
export const skillCategories = [
    ...
    skills: [
      {
        ...
        icon: (
          <Icon
            ...
            className="text-[#217346] w-5 h-5 shrink-0"
          />
        ),
      },
      {
        ...
        icon: (
          <Icon
            ...
            className="text-[#2B579A] w-5 h-5 shrink-0"
          />
        ),
      },
    ],
  },
  {
    ...
    skills: [
      {
        label: "C",
        icon: <Icon icon="devicon:c" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Python",
        icon: <Icon icon="logos:python" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Java",
        icon: <Icon icon="logos:java" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Flutter",
        icon: <Icon icon="logos:flutter" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "PHP",
        icon: <Icon icon="logos:php" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "JavaScript",
        icon: <Icon icon="logos:javascript" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "HTML5",
        icon: <Icon icon="logos:html-5" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "CSS3",
        icon: <Icon icon="logos:css-3" className="w-5 h-5 shrink-0" />,
      },
    ],
  },
  {
    ...
    skills: [
      {
        label: "Laravel",
        icon: <Icon icon="logos:laravel" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Node.js",
        icon: <Icon icon="logos:nodejs-icon" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Bootstrap",
        icon: <Icon icon="logos:bootstrap" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Tailwind",
        icon: (
          <Icon icon="logos:tailwindcss-icon" className="w-5 h-5 shrink-0" />
        ),
      },
    ],
  },
  {
    ...
    skills: [
      {
        label: "MySQL",
        icon: <Icon icon="logos:mysql" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "MariaDB",
        icon: <Icon icon="logos:mariadb-icon" className="w-5 h-5 shrink-0" />,
      },
      {
        ...
        icon: (
          <Icon
            ...
            className="text-[#CC2927] w-5 h-5 shrink-0"
          />
        ),
      },
    ],
    ...
    skills: [
      {
        ...
        icon: (
          <Icon icon="logos:visual-studio-code" className="w-5 h-5 shrink-0" />
        ),
      },
      {
        label: "Android Studio",
        icon: <Icon icon="logos:android-icon" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "PhpMyAdmin",
        icon: (
          <Icon
            ...
            className="text-[#F0970E] w-5 h-5 shrink-0"
          />
        ),
      },
      {
        ...
        icon: (
          <Icon
            ...
            className="text-[#1BA0D7] w-5 h-5 shrink-0"
          />
        ),
      },
      {
        label: "Arduino IDE",
        icon: <Icon icon="logos:arduino" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "GitHub",
        icon: <Icon icon="logos:github-icon" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Git",
        icon: <Icon icon="logos:git-icon" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Canva",
        icon: (
          <Icon
            ...
            className="text-[#00C4CC] w-5 h-5 shrink-0"
          />
        ),
      },
    ],
  },
  {
    ...
    skills: [
      {
        label: "Linux CLI",
        icon: <Icon icon="logos:linux-tux" className="w-5 h-5 shrink-0" />,
      },
      {
        label: "Bash Scripting",
        icon: <Icon icon="logos:bash" className="w-5 h-5 shrink-0" />,
      },
    ],
  },
  {
    ...
    skills: [
      {
        ...
        icon: (
          <Icon
            ...
            className="text-[#E7352C] w-5 h-5 shrink-0"
          />
        ),
      },
      {
    ...
    skills: [
      {
        ...
        icon: (
          <Icon icon="flat-color-icons:support" className="w-5 h-5 shrink-0" />
        ),
      },
      {
        label: "Hardware Troubleshooting",
        icon: (
          <Icon icon="flat-color-icons:services" className="w-5 h-5 shrink-0" />
        ),
      },
      {
        label: "Time Management",
        icon: (
          <Icon icon="flat-color-icons:clock" className="w-5 h-5 shrink-0" />
        ),
      },
      {
        label: "Problem Solving",
        icon: (
          <Icon icon="flat-color-icons:idea" className="w-5 h-5 shrink-0" />
        ),
      },
      {
        label: "Teamwork",
      ...
      },
      {
        label: "Multitasking",
        icon: (
          <Icon icon="flat-color-icons:workflow" className="w-5 h-5 shrink-0" />
        ),
      },
      {
        label: "Adaptability",
        icon: (
          <Icon
            icon="flat-color-icons:synchronize"
            className="w-5 h-5 shrink-0"
          />
        ),
      },
      {
        label: "Communication",
        icon: <Icon icon="flat-color-icons:sms" className="w-5 h-5 shrink-0" />,
      },
    ],
  },
];
...
export const projectsData = [
  {
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiEEr6BEOpgGsprCMPiM_rM6Vm58Uuj3RbkFTxpFtDydNSvxSH1vsyHCQ3uKJ89FHVoA4PLOBcBRZNSrFw71TD6oMMAiBGEwdqmpSE_w4zP1D-LqzYdNHHMwtAa-yiimXvyXhVOof6z5PDef2Tpr6AZUqjCBUQjm8LUjAOP_eC-49QqCvtwbdbrTQ58kS8/s600/177436.png",
  },
  {
    id: 7,
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEgkcajdR6bur9VSw4TGC_-feuZgWKAAdpyVYlRlEtj5QvZ-N3QubDBHYTbIxeQiUKqygSZwjUOlw7nKhfayuclvYC24zcBGit6KvYAojL4tv_yMdBLsSxQoPK5SIqXgbpgwd82TH2pcEUtf2oN8uSqbAZAGDJ97B5ctrblISDt60P0-M7KAot7Jqb2pWMY/s600/ChatGPT%20Image%2030%20Jun%202026,%2018.05.05.png",
  },
  {
    id: 6,
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEh23PDqnZSMv2-ReEWKHXyxnxdoHU7Dh0cFzfxzobK-R7kq733XqLvYMxtsYsLQCbQmCwFvDRwNmCVIsY-FSCtalkg4N485gKDyK2zB0hR3YydrUt_3SBB_IbQYXVbYrHRXoAi85pDM90U7i0-5XJqMeGSAn-JgIsg9utNDPDdSI17XtSevvlOYYQWXTBQ/s600/176404.png",
  },
  {
    id: 5,
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEi6uKesU6dTiifFLrS5wzHtZSPVcVna1KBT96gdp6kYl4Qi-Upr2wHTgvw8HzF9RmqwpakDMVAmIqwljhWEKUU_Qu-NmZvH6CgS5jRY-6JHzGlO3pXkmT8qBKysZwtbH64FstHJgmkXiiw9f7kaND7EEdsMD_cjEXo3ocdgF9bzQMFpqJvwNTRGZicGXJY/s600/176390.png",
  },
  {
    id: 4,
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEiNiw-0b-SSjazq4RHFksX7NM4SLPVrYS-6JlLDfq4dvQBmlsr8sbFtWzhFmfNC8dPvdDoByIYiOQWxKimuM8YXCJQgStyPgSiHNJaDRK-1nlQqBfTShpLOwlaB_CCRmSag4E_0h8FYmysHXPzsQ64QvmDGtZIXkSBM7khdW-2My_7ZLjKCAnNVbFb7Cik/s600/ChatGPT%20Image%2029%20Jun%202026,%2020.10.30.png",
  },
  {
    id: 3,
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEikXx9Nz55Huv-W28hQsCYXhaWarxHMIH_jXSKdxvs5J-_VJVQxjPk2bFmZUmb_6dzQfZUQKMp1MK8BRcyR747zf_5faP3zPLNG6_uCJer4qrcx7iAU9rOO8efixS_PPbQFOH1JpBYv463d8sPaHdWhsIT6mMM11dtD_pI23K5Tv7stA_B9Qgq8mDmBkIg/s600/ChatGPT%20Image%2029%20Jun%202026,%2019.58.18.png",
  },
  {
    id: 2,
    ...
    image:
      "https://blogger.googleusercontent.com/img/b/R29vZ2xl/AVvXsEhz7YVWt9JHm-f4KbkYauga2wdcq2crtPQfixXGgWoOrXbbMs1mAZVdisTCjpYjxBCn9QWIy_rSm4kEuDpzgKJeZ3qV5OsnE7k78OLrVjoCZxOM61EG9jpyUCLhOZCOaClBamUyehaXQ4AS_vwF2JS8x3Qe5HqZh35X0HB4fOw973b7I6zixwcjX7mwXfY/s600/ChatGPT%20Image%2029%20Jun%202026,%2019.39.53.png",
  },
  {
    id: 1,
