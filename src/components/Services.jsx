...
export default function Services() {
  ...
  return (
    <section id="services" className="py-16 max-w-5xl mx-auto">
      ...
      <p
        className="text-center text-gray-600 dark:text-gray-400 max-w-xl mx-auto mb-12 scroll-animate"
        style={{ transitionDelay: "0.05s" }}
      >
        I work at the intersection of development and infrastructure, making
        sure things not only look great but run smoothly behind the scenes.
      </p>
