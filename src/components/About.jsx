  ...
  return (
    <section id="about" className="py-16 max-w-5xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="rounded-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-800 relative h-full overflow-hidden p-4 sm:p-6 scroll-animate" style={{ transitionDelay: "0.15s" }}>
      ...
      <div className="mt-6 rounded-lg bg-white dark:bg-gray-800 border border-gray-100 dark:border-gray-800 p-4 sm:p-6 scroll-animate" style={{ transitionDelay: "0.2s" }}>
