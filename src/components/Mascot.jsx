      ...
      <div className="relative">
        ...
        {mascotOpen && (
          <div className="absolute bottom-20 md:bottom-28 right-0 w-72 p-4 bg-white dark:bg-gray-800 border border-brand-purple/30 dark:border-brand-purple/50 rounded-2xl shadow-2xl z-50 text-left">
            ...
            <div className="mt-3 flex items-center justify-between text-[10px] text-segawa-plum dark:text-segawa-plum-light font-bold border-t border-brand-purple/10 dark:border-brand-purple/25 pt-2">
              <span>Segawa Onpu 🎶</span>
